...
void ReshapeGL (int width, int height)									// Reshape The Window When It's Moved Or Resized
{
	...
	glOrtho(CGame::mViewingVolumeXMin, CGame::mViewingVolumeXMax, CGame::mViewingVolumeYMin, CGame::mViewingVolumeYMax, CGame::mViewingVolumeZMin, CGame::mViewingVolumeZMax);
